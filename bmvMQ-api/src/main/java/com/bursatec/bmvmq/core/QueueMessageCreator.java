 ...
 * @version 1.0
 */
public class QueueMessageCreator extends AbstractMessageCreator {
	 ...
	 */
	public QueueMessageCreator(final Session session,
		...
		MBeanFactory.createMbean(stats, MBeanFactory.buildSenderName(destinationName));
		setStats(stats);
	}

	@Override
	protected final Destination getDestination(final Session session,
