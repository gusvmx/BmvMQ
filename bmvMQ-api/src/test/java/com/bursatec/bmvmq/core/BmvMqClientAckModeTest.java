 ...
 *
 */
public class BmvMqClientAckModeTest {
	...
	/***/
	private static final String MESSAGE = BmvMqClientAckModeTest.class.getName() + "Message";
	/***/
	private static final int SUBSCRIPTION_TIME = 500;
	/***/
	private static final String DESTINATION = BmvMqClientAckModeTest.class.getName();
	/**
	...
	public final void start() throws FileNotFoundException {
		this.mqTemplate = BmvMqFactory.activeMQ();
	}
